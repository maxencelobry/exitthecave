...
const SEARCH_URL = "https://www.apec.fr/candidat/recherche-emploi.html/emploi?lieux=592230&distance=10&sortsType=DATE&typesConvention=143684&typesConvention=143685&typesConvention=143686&typesConvention=143687&typesConvention=143706&anciennetePublication=101850";
...
export class ApecScrapper {
  ...
  private log(message: string): void { console.log(`[APEC] ${message}`); }
